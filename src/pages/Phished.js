            ...
            <div style={styles.taff}>
                ...
                <div style={styles.texte}>
                    ...
                    <ul>
                        ...
                        <li style={styles.text_list}>
                            Télécharger <a href="http://localhost:3000/">notre logiciel</a> permettant de vérifier la validité d'un lien, ce qui permet donc de savoir si le lien est fiable ou non.
                        </li><br />
