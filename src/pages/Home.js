        ...
        return (
            <div style={styles.taff}>
                ...
                <div style={styles.texte}>
                    ...
                    <div style={styles.appli}>
                        <b>Télécharger notre logiciel permettant de vérifier la validité d'un lien, ce qui permet donc de savoir si le lien est fiable ou non.<br/>
                        il vous suffit de télécharger notre application : appli.</b>
                    </div>
                </div>
            </div>
        );
